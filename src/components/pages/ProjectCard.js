            ...
            <div className="dark:bg-slate-800 rounded overflow-hidden shadow-2xl">
                ...
                <div className="px-5 pt-5 pb-6 ">
                    <div className="flex items-center justify-between">
                        <h2 className="text-white text-xl font-bold">{title ? title : ""}</h2>
                        <p className="text-gray-500 text-xs capitalize">{projectType ? projectType : ""}</p>
                    </div>
                    ...
                    <div className="flex items-center gap-2 justify-start">
                        <a
                            href={live ? live : ""}
                            className=" text-xs bg-primary text-white  py-1.5 shadow-xl px-3 rounded"
                            target="_blank"
                            rel="noreferrer"
                        >
                            Live

...
const Footer = () => {
    return (
        <footer className="footer p-7 absolute bottom-0 max-w-screen-2xl bg-slate-100 text-black dark:bg-black dark:text-white">
            <div>
                ...
                <p>Property of Sofiuzzaman Sofi.<br />© Copyright 2022. All Rights Reserved.</p>
            </div>
            <div>
